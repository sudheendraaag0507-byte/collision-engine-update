...
glm::mat4 controlsFunction(GLFWwindow* window  ) {
	static float angle = 0.0f , angle1 = 0.0f , scl = 1.0f;
	...
	viewTilt = glm::rotate(glm::mat4(1.0f), glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f)) * glm::rotate(glm::mat4(1.0f), glm::radians(angle1), glm::vec3(1.0f, 0.0f, 0.0f));
